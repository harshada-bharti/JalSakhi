...
const Worker = lazy(() => import("./pages/Worker.tsx"));
      ...
      <ConvexAuthProvider client={convex}>
        <BrowserRouter>
          ...
          <Suspense fallback={<RouteLoading />}>
            <Routes>
              {/* Public: landing / access screen with three separated options */}
              <Route path="/" element={<Landing />} />
              {/* Resident: no login required */}
              <Route path="/report" element={<Report />} />
              <Route path="/track" element={<Track />} />
              {/* Staff: separate logins per role */}
              <Route path="/login/:role" element={<StaffLogin />} />
              {/* Worker dashboard — only complaints assigned to that worker */}
              <Route
                path="/worker"
                element={
              ...
              />
              {/* Admin dashboard — full oversight and final verification */}
              <Route
                path="/admin"
                element={
